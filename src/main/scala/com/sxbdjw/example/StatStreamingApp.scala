//package com.sxbdjw.example
//
//import com.sxbdjw.example.dao.{CourseClickCountDao, CourseSearchClickCountDAO}
//import com.sxbdjw.example.domain.{CourseClickCount, CourseSearchClickCount}
